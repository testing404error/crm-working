-- =====================================================
-- FIXED USER SIGNUP TRIGGER (WITHOUT STATUS COLUMN)
-- =====================================================
...
-- 2. Create function to handle new user creation (without status column)
...
-- 5. Create missing user records for existing auth users (without status column)
INSERT INTO public.users (auth_user_id, name, email, role, team, avatar)
SELECT 
  au.id,
